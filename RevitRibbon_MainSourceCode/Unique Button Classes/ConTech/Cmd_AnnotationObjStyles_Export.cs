...
namespace RevitRibbon_MainSourceCode//.Unique_Button_Classes.ConTech
{
    ...
    public class Cmd_AnnotationObjStyles_Export : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            try
            {
                ...
                List<Category> typeCategories = ExportersCommonTools.GetCategoriesByType(doc, CategoryType.Annotation);
                ...
                if (typeCategories != null && typeCategories.Any())
                {
                    ...
                    ExportersCommonTools.ExportDataToEPPlusWithSaveAs(exportDataList, $"Object Styles - {categoryName} Objects");
                }
                else
                {
